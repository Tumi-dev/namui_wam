...
// Clase para la pantalla de un nivel de la actividad 4 en desarrollo
class Activity4LevelScreen extends BaseLevelScreen {
...
// Clase para el estado de la pantalla de un nivel de la actividad 4 en desarrollo
class _Activity4LevelScreenState extends BaseLevelScreenState<Activity4LevelScreen> {
  ...
  Future<void> _loadLevelData() async {
    try {
      await _activity4Service.getLevelData(widget.level);
      if (mounted) {
        setState(() {
          _isLoading = false;
        });
