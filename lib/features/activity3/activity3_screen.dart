...
class Activity3Screen extends StatelessWidget {
  ...
  // Navega hacia la pantalla de un nivel de la actividad 3 al seleccionar un nivel
  void _onLevelSelected(BuildContext context, LevelModel level) {
    // Navegar a la pantalla del nivel seleccionado de la actividad 3
    Navigator.push(
      context,
      MaterialPageRoute(
  ...
  // Construye la pantalla de la actividad 3 con los niveles disponibles
  @override
  Widget build(BuildContext context) {
    return Consumer<ActivitiesState>(
      builder: (context, activitiesState, child) {
        ...
        // Construir la pantalla de la actividad 3 con los niveles disponibles
        return Scaffold(
  ...
  // Construye una tarjeta para un nivel de la actividad 3
  Widget _buildLevelCard(BuildContext context, LevelModel level) {
    // Construir una tarjeta para un nivel de la actividad 3
    return Padding(
