...
// La clase no extiende BaseActivityScreen sino que implementa la misma estructura
class Activity5Screen extends StatelessWidget {
  const Activity5Screen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Consumer<ActivitiesState>(
      builder: (context, activitiesState, child) {
        final activity = activitiesState.getActivity(5);
        ...
        return Scaffold(
          ...
          appBar: AppBar(
            ...
            title: const Text(
              'Aprendamos el dinero en Namtrik',
